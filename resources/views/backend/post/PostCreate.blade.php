...
<div class="col-md-12" style="margin: auto; margin-top: 50px;">
    <div class="panel panel-primary">
        <div class="panel-heading" style="background-color: #152555; color: white; padding: 10px; border-radius: 5px 5px 0px 0px ;">Add post</div>
            ...
            <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
                ...
                <div class="row" style="margin-top:5px;">
                    ...
                    <div class="col-md-10">
                        ...
                        <textarea name="content" id="post-content" rows="10" cols="80" class="form-control"></textarea>
                ...
                <div class="row" style="margin-top:5px;">
                    ...
                    <div class="col-md-1">
                        <input type="checkbox" name="recommend" class="form-control">
                    </div>
                </div>
                <!-- end rows -->
                ...
                <div class="row" style="margin-top:5px;">
                    ...
                    <div class="col-md-1">
                        <input type="checkbox" name="pin" class="form-control">
                    </div>
                </div>

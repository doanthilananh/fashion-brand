...
<link rel="shortcut icon" href="{{ asset('./../public/backend/images/user.png')}}" type="image/png">
</head>
<body>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"><?php $name= Session::get('admin_name');
					echo $name;
				?></span>
                <b class="caret"></b>
            </a>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('/all-category_product')}}">Liệt kê danh mục sản phẩm</a></li>
						<li><a href="{{url('/add-category_product')}}">Thêm danh mục sản phẩm</a></li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('/all-brand_product')}}">Liệt kê thương hiệu sản phẩm</a></li>
						<li><a href="{{url('/add-brand_product')}}">Thêm thương hiệu sản phẩm</a></li>

...
<div class="col-md-12" style="margin: auto; margin-top: 50px; margin-bottom: 400px;">
    <div class="panel panel-primary">
        <div class="panel-heading" style="background-color: #152555; color: white; padding: 10px; border-radius: 5px 5px 0px 0px; ">Update account</div>
        <div class="panel-body">
            <form method="post" action=" {{ route('account.update',isset($record->id)?$record->id:'') }} ">
                @method('PUT')

    ...
    <div class="category-tab"><!--category-tab-->
        <div class="col-sm-12">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tshirt" data-toggle="tab">VGA</a></li>
                <li><a href="#blazers" data-toggle="tab">CPU</a></li>
                <li><a href="#sunglass" data-toggle="tab">MAIN</a></li>
                <li><a href="#kids" data-toggle="tab">RAM</a></li>
                <li><a href="#poloshirt" data-toggle="tab">CASE</a></li>
            </ul>
        </div>
